...
const STATIC_PERIOD_WORKOUTS = [
  ...
  },
  {
    ...
    description: [
      ...
      "→ Spinach, beetroot, dates, jaggery (vellam), pomegranate",
      "",
      "Warm and comforting foods:",
      "→ Soups, dal, khichdi, warm milk",
      "",
      "Fruits for energy:",
      "→ Banana (reduces cramps), apple, orange",
      "",
      "Healthy fats:",
      "→ Nuts (almonds, walnuts), seeds (flax, sunflower)",
      "",
      "Magnesium-rich foods:",
      "→ Dark chocolate (small amount), leafy greens",
      "",
      "Protein sources:",
  ...
  },
  {
    ...
    description: [
      ...
      "→ Too much caffeine (coffee/tea) — increases cramps",
      "→ Cold drinks and ice cream (may worsen discomfort)",
  ...
  },
  {
    ...
    description: [
      ...
      "→ Try warm water instead of cold",
      "→ Herbal teas (ginger tea, chamomile tea) help reduce pain",
    ],
  },
  {
    id: "static-pr-13",
    ...
    description: [
      ...
      "→ Take a warm bath",
      "→ Light massage with coconut or lavender oil",
  ...
  },
  {
    ...
    difficulty: "Easy",
    description: [
      "→ Hormones may cause mood swings — it's normal",
      "→ Listen to music, watch something relaxing",
  ...
  },
  {
    ...
    description: [
      ...
      "→ 🍳 Breakfast: Banana + oats / eggs",
      "→ 🥗 Lunch: Rice + dal + vegetables",
      "→ ☕ Evening: Herbal tea + nuts",
      "→ 🍲 Dinner: Light meal (soup/chapati + sabzi)",
      "→ 🌙 Night: Warm milk + good sleep",
    ],
  },
  {
    id: "static-pr-16",
    ...
    difficulty: "Beginner",
    description: [
      "→ Very severe pain (not manageable)",
      "→ Extremely heavy bleeding",
      "→ Irregular cycles frequently",
    ],
  },
];
